...
export class n1680083928934 implements MigrationInterface {
    name = 'n1680083928934'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "screens" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "desc" character varying NOT NULL, "modulesId" integer, CONSTRAINT "PK_15b65ed44367c5411efccdd7de1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "screens" ADD CONSTRAINT "FK_b04a288eec531e3828c51fe1f43" FOREIGN KEY ("modulesId") REFERENCES "modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "screens" DROP CONSTRAINT "FK_b04a288eec531e3828c51fe1f43"`);
